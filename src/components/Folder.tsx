                    ...
                    {papers.map((item, i) => {
                        ...
                        return (
                            <div
                                ...
                                className={`absolute z-20 bottom-[10%] left-1/2 transition-all duration-300 ease-in-out ${!open ? 'transform -translate-x-1/2 translate-y-[10%] group-hover:translate-y-0' : 'hover:scale-110 hover:z-50'
                                    } ${sizeClasses}`}
                                style={{
