        ...
        const rootClasses = useMemo(
            () =>
                cx(
                    ...
                    'dark:[--logoloop-fadeColorAuto:var(--bg-primary)]',
        ...
        const renderLogoItem = useCallback(
            (item: LogoItem, key: React.Key) => {
                ...
                const content = isNodeItem ? (
                    ...
                    <img
                        className={cx(
                            'h-[var(--logoloop-logoHeight)] w-auto block object-contain filter grayscale opacity-60',
                            'transition-all duration-300 pointer-events-auto [-webkit-user-drag:none]',
                            'hover:grayscale-0 hover:opacity-100 drop-shadow-sm hover:drop-shadow-[0_0_15px_rgba(247,147,30,0.3)]',
                            'motion-reduce:transition-none',
                            scaleOnHover &&
                            'hover:scale-110 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/item:scale-110'
                        )}
                        src={(item as any).src}
